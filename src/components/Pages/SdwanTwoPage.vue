<template>
	<main id="content">
		<page-header>
			<template slot="title">SDWAN 2.0 Domestic</template>
...
import LicensingSection from '../PageSections/SmartLicensing';
...
import InterfaceSection from '../PageSections/InterfaceConfig.vue';
