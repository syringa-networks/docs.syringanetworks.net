...
!
username trouble privilege 15 secret T01ltoil
!
ip ssh rsa keypair-name cert-ssh
crypto key gen rsa label cert-ssh
ip ssh version 2
!
...
snmp-server location Shanghai [31.2304, 121.4737]
